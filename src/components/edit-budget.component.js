...
export default class EditBudget extends Component {
    ...
    componentDidMount(id) {
        ...
        Axios.get('https://personal-budget-node-server-4nds8.ondigitalocean.app/budget/' + this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        Axios.post('https://personal-budget-node-server-4nds8.ondigitalocean.app/budget/update/' + this.props.match.params.id, budget)
            .then(res => {
